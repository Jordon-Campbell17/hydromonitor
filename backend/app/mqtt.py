...
class MQTT:
    ...
    sub_topics = [("620162191", 0), ("620162191_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620162191", self.GDP) 
        self.client.message_callback_add("620162191_sub", self.toggle) 
